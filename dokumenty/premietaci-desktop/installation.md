...
1. Statická IP adresa - je užitočná nato 
...
2. Wake on LAN - aby sa počítač dal zapnúť vzdialene, napr. z domu, po pripojení do VPN
3. SSH server - aby sa do počítača dalo prihlásiť vzdialene (cez terminál)

V termináli (program _Konsole_) spustiť:

```shell
# Statická IP adresa a Wake on LAN
